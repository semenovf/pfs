...
// void test_stringify ()
// {
//     TEST_OK(pfs::to_string(date_type(2013, 11, 28), string_t("%Y-%m-%d")) == string_t("2013-11-28"));
//     TEST_OK(pfs::to_string(date_type(1, 2, 3), string_t("%Y-%m-%d")) == string_t("0001-02-03"));
//     TEST_OK(pfs::to_string(date_type(2013, 11, 28)) == string_t("2013-11-28"));
//     TEST_OK(pfs::to_string(date_type(1, 2, 3)) == string_t("0001-02-03"));
// }
