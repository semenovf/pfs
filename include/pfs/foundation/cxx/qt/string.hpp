...
typename string_traits<QString>::iterator
inline string_traits<QString>::xerase (
    data_type & d
...
template <>
inline int compare<QString> (
          string<QString> const & lhs
        , char const * rhs)
{
