...
//
//public:
//    typedef vector<T, container_value<T, typename internal_type::native_type> > container_value_type;
//    typedef vector<T, container_ref<T, typename internal_type::native_type> >   container_reference_type;
//    
